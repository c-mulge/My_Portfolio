...
const FloatingElements = () => {
  return (
    <>
      ...
      <div className="absolute bottom-32 right-40 animate-ping">
    ...
    <div className="h-screen w-screen relative overflow-hidden">
      <DarkGrid>
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto px-6">
          ...
          {/* Social Links */}
          <div className="social-links flex flex-wrap items-center justify-center gap-4 mb-16">
            {socialItems.map((item, index) => (
              <a
                ...
                className={`group flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg ${item.color}`}
              >
                {item.icon}
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
          <div className="absolute top-10 left-10 w-32 h-32 bg-gradient-radial from-orange-500/10 to-transparent rounded-full blur-xl"></div>
          <div className="absolute bottom-20 right-20 w-48 h-48 bg-gradient-radial from-orange-600/5 to-transparent rounded-full blur-2xl"></div>
          <div className="absolute top-1/3 right-10 w-24 h-24 bg-gradient-radial from-orange-400/8 to-transparent rounded-full blur-lg"></div>
        </div>
      </DarkGrid>
    </div>
  );
