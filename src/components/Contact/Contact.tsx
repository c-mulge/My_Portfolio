  ...
  return (
    ...
    >
      ...
      <div className="text-center max-w-2xl mx-auto relative z-10">
        ...
        >
          Let’s Connect &<span className="block mt-4">Build Something</span>
        </motion.h1>
        ...
        >
          I’m always open to conversations about technology, data science,
          AI/ML, backend systems, and creative ideas.
          <br />
          Whether it’s collaboration, learning, or opportunities.
        </motion.p>
